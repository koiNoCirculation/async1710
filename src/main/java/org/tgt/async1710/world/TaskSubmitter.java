...
public interface TaskSubmitter {
    default <T> Optional<CompletableFuture<T>> submit(Callable<T> task) throws Exception {
    ...
    default Optional<CompletableFuture<?>> submit(Runnable task) {
        String threadName = ((WorldUtils) this).getThreadName();
        boolean running = ((WorldUtils) this).getRunning();
    ...
    default <T> Optional<CompletableFuture<T>> submit(Callable<T> task, CallbackInfo ci) throws Exception {
        String threadName = ((WorldUtils) this).getThreadName();
        boolean running = ((WorldUtils) this).getRunning();
    ...
    default Optional<CompletableFuture<?>> submit(Runnable task, CallbackInfo ci) {
        String threadName = ((WorldUtils) this).getThreadName();
        boolean running = ((WorldUtils) this).getRunning();
    ...
    default <T> Optional<CompletableFuture<T>> submit(Callable<T> task, CallbackInfoReturnable<T> ci, T defaultValue) throws Exception {
        String threadName = ((WorldUtils) this).getThreadName();
        boolean running = ((WorldUtils) this).getRunning();
    ...
    default Optional<CompletableFuture<?>> submit(Runnable task, CallbackInfoReturnable<?> ci) {
        String threadName = ((WorldUtils) this).getThreadName();
        boolean running = ((WorldUtils) this).getRunning();
    ...
    <T> CompletableFuture<T> submit0(Callable<T> task);

    CompletableFuture<?> submit0(Runnable task);
